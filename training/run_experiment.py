...
def _import_class(module_and_class_name: str) -> type:
    """Import class from a module, e.g. 'motion_summarizer.models.MLP'"""
...
def _setup_parser():
    ...
    data_class = _import_class(f"motion_summarizer.data.{temp_args.data_class}")
    model_class = _import_class(f"motion_summarizer.models.{temp_args.model_class}")
